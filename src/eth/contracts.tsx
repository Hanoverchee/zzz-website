...
//    name: "UNIC",
 //   address: "0x37114773d5d74bd27c8e1167aeb50a6e0a3a354c",
  ...
  CORGI: {
    name: "CORGI",
    address: "0x151220cf596c3ac80736a7ef7036c6f1b30aaf48",
    abi: require("./abi/erc20_abi.json"),
    decimals: 9,
  },
  CORGIETH: {
    name: "CORGI/ETH",
    address: "0x5036ff28f4d9200b61ad92548abf1ab4da51f250",
    abi: require("./abi/erc20_abi.json"),
    decimals: 18,
  },
  ZZZCORGI: {
    name: "CORGI/ETH",
    address: "0x183177FE522EFda4FF4273D94D971887dF0eEe2A",
    abi: require("./abi/erc20_abi.json"),
    decimals: 18,
  },
};
...
export const pools: Pool[] = [
  {
    ...
    uniToken: tokens.ZZZCORGI,
    usesNewAbi: true,
    category: PoolCategory.ZZZ,
    isMigrationPool: false,
    v4: true,
    boostTokens: [tokens.Axioms, tokens.NAPV2, tokens.DAI, tokens.RFI],
    startTime: 1612306836,
  },
  {
    id: "1029420",
    name: "CORGI/ETH",
    ...
    purchaseFrom:
      "https://info.uniswap.org/pair/0x5036ff28f4d9200b61ad92548abf1ab4da51f250",
    poolStatus: PoolStatus.Ongoing,
    poolType: PoolType.LP,
    boostLevels: boostLevels.v4,
    rewardTokenPair: tokens.WETH,
    uniPairToken: tokens.WETH,
    uniToken: tokens.CORGIETH,
    usesNewAbi: true,
    category: PoolCategory.ZZZ,
    isMigrationPool: false,
    v4: true,
